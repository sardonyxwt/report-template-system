...
export const REPORT_DATA_EXAMPLE = ReportDataSchema.parse({
  blocks: [
    {
      type: 'cover',
      value: {
        title: 'Doron’s Health Report',
        clinic: 'Longevity Clinic',
        assessmentDate: '2026-06-29',
        generatedAt: '2026-06-29T16:59:19.000Z',
        patient: {
          name: 'Doron Patient',
